...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private Button getWordDefinition = null;
    ...
    private class GetWordDefinitionButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), word, wordDefinitionTextView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWordDefinition = (Button)findViewById(R.id.get_word_definition_button);
        getWordDefinition.setOnClickListener(getWordDefinitionButtonClickListener);
